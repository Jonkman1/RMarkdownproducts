...
\usepackage[hyphens]{url}
  ...
  \journal{Een bepaald tijdschrift} % Sets Journal name
...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Leefomstandigheden inwoners met een Antilliaanse achtergrond in Den Haag},
            colorlinks=true,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{Leefomstandigheden inwoners met een Antilliaanse achtergrond in Den Haag}
    \author[Verwey-Jonker Instituut]{Esther Horrevorts\corref{c1}}
   \ead{EHorrevortse@Verwey-Jonker.nl} 
   \cortext[c1]{Corresponding Author}
    \author[Verwey-Jonker Instituut]{Hans Bellaart}
   \ead{HBellaart@Verwey-Jonker.nl} 
